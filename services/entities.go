...
// List Entities
func (r *EntityService) ListAutoPaging(ctx context.Context, query requests.EntityListParams, opts ...option.RequestOption) *responses.PageAutoPager[responses.Entity] {
