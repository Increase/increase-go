...
func (r *SimulationsCardDisputeService) Action(ctx context.Context, card_dispute_id string, body *requests.SimulatesAdvancingTheStateOfACardDisputeParameters, opts ...options.RequestOption) (res *responses.CardDispute, err error) {
