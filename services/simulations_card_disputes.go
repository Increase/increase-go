...
func NewSimulationsCardDisputeService(opts ...option.RequestOption) (r *SimulationsCardDisputeService) {
...
func (r *SimulationsCardDisputeService) Action(ctx context.Context, card_dispute_id string, body *requests.CardDisputeActionParams, opts ...option.RequestOption) (res *responses.CardDispute, err error) {
