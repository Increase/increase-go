...
// List Inbound ACH Transfer Returns
func (r *InboundACHTransferReturnService) ListAutoPaging(ctx context.Context, query requests.InboundACHTransferReturnListParams, opts ...option.RequestOption) *responses.PageAutoPager[responses.InboundACHTransferReturn] {
