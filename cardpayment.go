...
func (r CardPaymentElementsCardRefundPurchaseDetailsFleetServiceType) IsKnown() bool {
	switch r {
	case CardPaymentElementsCardRefundPurchaseDetailsFleetServiceTypeFullService, CardPaymentElementsCardRefundPurchaseDetailsFleetServiceTypeSelfService:
		return true
	}
	return false
}
...
func (r CardPaymentElementsCardSettlementPurchaseDetailsFleetServiceType) IsKnown() bool {
	switch r {
	case CardPaymentElementsCardSettlementPurchaseDetailsFleetServiceTypeFullService, CardPaymentElementsCardSettlementPurchaseDetailsFleetServiceTypeSelfService:
		return true
	}
	return false
}
