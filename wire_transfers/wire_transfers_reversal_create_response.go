...
type WireTransfersReversalCreateResponse struct {
...
// The amount that was reversed.
func (r *WireTransfersReversalCreateResponse) GetAmount() (Amount int64) {
...
// The description on the reversal message from Fedwire.
func (r *WireTransfersReversalCreateResponse) GetDescription() (Description string) {
...
// The Fedwire cycle date for the wire reversal.
func (r *WireTransfersReversalCreateResponse) GetInputCycleDate() (InputCycleDate string) {
...
// The Fedwire sequence number.
func (r *WireTransfersReversalCreateResponse) GetInputSequenceNumber() (InputSequenceNumber string) {
...
// The Fedwire input source identifier.
func (r *WireTransfersReversalCreateResponse) GetInputSource() (InputSource string) {
...
// The Fedwire transaction identifier.
func (r *WireTransfersReversalCreateResponse) GetInputMessageAccountabilityData() (InputMessageAccountabilityData string) {
...
// The Fedwire transaction identifier for the wire transfer that was reversed.
func (r *WireTransfersReversalCreateResponse) GetPreviousMessageInputMessageAccountabilityData() (PreviousMessageInputMessageAccountabilityData string) {
...
// The Fedwire cycle date for the wire transfer that was reversed.
func (r *WireTransfersReversalCreateResponse) GetPreviousMessageInputCycleDate() (PreviousMessageInputCycleDate string) {
...
// The Fedwire sequence number for the wire transfer that was reversed.
func (r *WireTransfersReversalCreateResponse) GetPreviousMessageInputSequenceNumber() (PreviousMessageInputSequenceNumber string) {
...
// The Fedwire input source identifier for the wire transfer that was reversed.
func (r *WireTransfersReversalCreateResponse) GetPreviousMessageInputSource() (PreviousMessageInputSource string) {
...
// Information included in the wire reversal for the receiving financial
// institution.
func (r *WireTransfersReversalCreateResponse) GetReceiverFinancialInstitutionInformation() (ReceiverFinancialInstitutionInformation string) {
...
// Additional financial institution information included in the wire reversal.
func (r *WireTransfersReversalCreateResponse) GetFinancialInstitutionToFinancialInstitutionInformation() (FinancialInstitutionToFinancialInstitutionInformation string) {
