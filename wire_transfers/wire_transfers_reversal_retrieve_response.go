...
type WireTransfersReversalRetrieveResponse struct {
...
// The amount that was reversed.
func (r *WireTransfersReversalRetrieveResponse) GetAmount() (Amount int64) {
...
// The description on the reversal message from Fedwire.
func (r *WireTransfersReversalRetrieveResponse) GetDescription() (Description string) {
...
// The Fedwire cycle date for the wire reversal.
func (r *WireTransfersReversalRetrieveResponse) GetInputCycleDate() (InputCycleDate string) {
...
// The Fedwire sequence number.
func (r *WireTransfersReversalRetrieveResponse) GetInputSequenceNumber() (InputSequenceNumber string) {
...
// The Fedwire input source identifier.
func (r *WireTransfersReversalRetrieveResponse) GetInputSource() (InputSource string) {
...
// The Fedwire transaction identifier.
func (r *WireTransfersReversalRetrieveResponse) GetInputMessageAccountabilityData() (InputMessageAccountabilityData string) {
...
// The Fedwire transaction identifier for the wire transfer that was reversed.
func (r *WireTransfersReversalRetrieveResponse) GetPreviousMessageInputMessageAccountabilityData() (PreviousMessageInputMessageAccountabilityData string) {
...
// The Fedwire cycle date for the wire transfer that was reversed.
func (r *WireTransfersReversalRetrieveResponse) GetPreviousMessageInputCycleDate() (PreviousMessageInputCycleDate string) {
...
// The Fedwire sequence number for the wire transfer that was reversed.
func (r *WireTransfersReversalRetrieveResponse) GetPreviousMessageInputSequenceNumber() (PreviousMessageInputSequenceNumber string) {
...
// The Fedwire input source identifier for the wire transfer that was reversed.
func (r *WireTransfersReversalRetrieveResponse) GetPreviousMessageInputSource() (PreviousMessageInputSource string) {
...
// Information included in the wire reversal for the receiving financial
// institution.
func (r *WireTransfersReversalRetrieveResponse) GetReceiverFinancialInstitutionInformation() (ReceiverFinancialInstitutionInformation string) {
...
// Additional financial institution information included in the wire reversal.
func (r *WireTransfersReversalRetrieveResponse) GetFinancialInstitutionToFinancialInstitutionInformation() (FinancialInstitutionToFinancialInstitutionInformation string) {
