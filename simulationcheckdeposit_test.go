...
func TestSimulationCheckDepositAdjustmentWithOptionalParams(t *testing.T) {
	...
	_, err := client.Simulations.CheckDeposits.Adjustment(
		...
		increase.SimulationCheckDepositAdjustmentParams{
			Amount: increase.F(int64(-1000000000)),
			Reason: increase.F(increase.SimulationCheckDepositAdjustmentParamsReasonLateReturn),
		},
	)
	if err != nil {
