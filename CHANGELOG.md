...
Full Changelog: [...abc-v0.0.1](https://github.com/Increase/increase-go/compare/...abc-v0.0.1)
...
* **api:** add `ach_debit_status` ([#165](https://github.com/Increase/increase-go/issues/165)) ([3e470ce](https://github.com/Increase/increase-go/commit/3e470ced0927b565f310acf21928e01a5cd8d5a8))
...
* **api:** add `suspected_fraud` rejection reason ([#155](https://github.com/Increase/increase-go/issues/155)) ([25f50b9](https://github.com/Increase/increase-go/commit/25f50b9580bfe29030f5f9eada40c92a3c951bd4))
* **api:** add addenda details for ACH transfers ([#124](https://github.com/Increase/increase-go/issues/124)) ([05dd007](https://github.com/Increase/increase-go/commit/05dd0075eef5719f28df54c251e635c659ff37d1))
* **api:** add bank_of_first_deposit_routing_number and transfer_id properties ([#82](https://github.com/Increase/increase-go/issues/82)) ([8c790ab](https://github.com/Increase/increase-go/commit/8c790ab8ec4ef5c6d61ba8f0e32d1517874e95fb))
...
* **api:** add card payment ID reference to transaction models ([#94](https://github.com/Increase/increase-go/issues/94)) ([a4dd0a5](https://github.com/Increase/increase-go/commit/a4dd0a5212edf0de98534c11568fb8301db0c0f9))
* **api:** add card payments endpoints ([#109](https://github.com/Increase/increase-go/issues/109)) ([513d4cb](https://github.com/Increase/increase-go/commit/513d4cbcf188d06232d96955ccda5dc4025d0c2c))
...
* **api:** add deposit_submission property to check deposit ([#158](https://github.com/Increase/increase-go/issues/158)) ([9a532cf](https://github.com/Increase/increase-go/commit/9a532cf9c72ae73865472bb34cdbd1da2c753e2a))
* **api:** add direction property to CardAuthorization ([#115](https://github.com/Increase/increase-go/issues/115)) ([08d6ddb](https://github.com/Increase/increase-go/commit/08d6ddbecd516c44a57d97049dddf101795309fc))
* **api:** add entity_id to Card and make relationship nullable ([#100](https://github.com/Increase/increase-go/issues/100)) ([b9e13e6](https://github.com/Increase/increase-go/commit/b9e13e6bdac79d84f469f555422b8834da0b2db1))
* **api:** add failed to export status enum ([#139](https://github.com/Increase/increase-go/issues/139)) ([bb6b610](https://github.com/Increase/increase-go/commit/bb6b610e15556ccb913bbc493deca0df417677d5))
...
* **api:** add fuel confirmation functionality ([#132](https://github.com/Increase/increase-go/issues/132)) ([63a0abf](https://github.com/Increase/increase-go/commit/63a0abf37160d05e3d74bc1a3d4b663445cd934a))
* **api:** add inbound checks, originating routing number and new event types ([#105](https://github.com/Increase/increase-go/issues/105)) ([d2364a3](https://github.com/Increase/increase-go/commit/d2364a3c5e5252da5df45eb7379582810fd9b162))
* **api:** add merchant data to simulation api ([#170](https://github.com/Increase/increase-go/issues/170)) ([380c687](https://github.com/Increase/increase-go/commit/380c68744398e3118a47aab7ac63e669c442eb55))
* **api:** add network identifiers and effective date ([#136](https://github.com/Increase/increase-go/issues/136)) ([5e53c24](https://github.com/Increase/increase-go/commit/5e53c24668ab91f4fc1e12aafb93720df072eb9c))
...
* **api:** add oauth token and inbound wire transfer methods ([#180](https://github.com/Increase/increase-go/issues/180)) ([efd27b2](https://github.com/Increase/increase-go/commit/efd27b23306b3d106f1ef45c9153925008830a6e))
...
* **api:** add physical cards endpoints ([#107](https://github.com/Increase/increase-go/issues/107)) ([096d574](https://github.com/Increase/increase-go/commit/096d574655a43f51836186c3032b2a99b213b881))
...
* **api:** add real-time payments request for payment endpoints ([#162](https://github.com/Increase/increase-go/issues/162)) ([7e29697](https://github.com/Increase/increase-go/commit/7e29697d4c7237f9804c20fede1df6d84a16db7e))
* **api:** add returned_per_odfi_request enum ([#130](https://github.com/Increase/increase-go/issues/130)) ([a1013e0](https://github.com/Increase/increase-go/commit/a1013e0dd22db96ac4544cd69f2014b7252bd226))
...
* **api:** add Update Address  and Create Notification Change endpoints ([#86](https://github.com/Increase/increase-go/issues/86)) ([a82838c](https://github.com/Increase/increase-go/commit/a82838c48b937af33809f48a809ae378ae702d41))
...
* **api:** expand event categories and Entity status options ([#113](https://github.com/Increase/increase-go/issues/113)) ([8beb60a](https://github.com/Increase/increase-go/commit/8beb60aa370a779fa2d07f73dc766c2e9a8ca80d))
* **api:** export account statements in OFX format ([#102](https://github.com/Increase/increase-go/issues/102)) ([7bb32e9](https://github.com/Increase/increase-go/commit/7bb32e939bbd0792aafb93d7e324c256dba22745))
* **api:** list Inbound Wire Transfers, change transfer simulation return types ([#183](https://github.com/Increase/increase-go/issues/183)) ([9cc51a7](https://github.com/Increase/increase-go/commit/9cc51a776a26c68c3c1a9f32f585ad7f727d3bdd))
...
* **api:** remove Limits API, add ACH controls to Account Numbers   ([#92](https://github.com/Increase/increase-go/issues/92)) ([37b0cdd](https://github.com/Increase/increase-go/commit/37b0cddd99d21855a6bdb29cc6337f43d36dbe43))
* **api:** remove unused `/inbound_ach_transfer_returns` endpoints ([#81](https://github.com/Increase/increase-go/issues/81)) ([ae82f7a](https://github.com/Increase/increase-go/commit/ae82f7a8f2ec0286868a0c0f657226dbe3053c33))
...
* **api:** restructure balance lookups ([#142](https://github.com/Increase/increase-go/issues/142)) ([c92f43b](https://github.com/Increase/increase-go/commit/c92f43bc12b244302826f266eabc9e1620f1f96a))
* **api:** simplify WireDecline and InboundWireTransfer ([#181](https://github.com/Increase/increase-go/issues/181)) ([1c292e9](https://github.com/Increase/increase-go/commit/1c292e9218fa28d2d1beafb227fd504a2753ade4))
* **api:** split card profile resource into digital and physical card profile resources ([#196](https://github.com/Increase/increase-go/issues/196)) ([7bc4e7b](https://github.com/Increase/increase-go/commit/7bc4e7b0190ec9444ba9b8cd2296b28c125dade1))
* **api:** update descriptions ([#185](https://github.com/Increase/increase-go/issues/185)) ([fe8583b](https://github.com/Increase/increase-go/commit/fe8583bbf1aedbc7adc96be37dbad8a4e0c704db))
...
* **api:** updates ([#125](https://github.com/Increase/increase-go/issues/125)) ([125da3d](https://github.com/Increase/increase-go/commit/125da3d01be21a6cb4f508d74fd6f9d71d19116d))
* **api:** updates ([#126](https://github.com/Increase/increase-go/issues/126)) ([c8ace64](https://github.com/Increase/increase-go/commit/c8ace645a284cac16f03f2ed9b9e45027d17efeb))
* **api:** updates ([#128](https://github.com/Increase/increase-go/issues/128)) ([2937ac2](https://github.com/Increase/increase-go/commit/2937ac2231341071c23dd1a5cae92837014e4249))
* **api:** updates ([#135](https://github.com/Increase/increase-go/issues/135)) ([49420cc](https://github.com/Increase/increase-go/commit/49420ccbae287e0066c1f499aa2199693915da7d))
* **api:** updates ([#152](https://github.com/Increase/increase-go/issues/152)) ([385215f](https://github.com/Increase/increase-go/commit/385215fd54acf5be23618fde0f82deb41117dcea))
...
* **client:** adjust retry behavior ([#133](https://github.com/Increase/increase-go/issues/133)) ([8f6f8f7](https://github.com/Increase/increase-go/commit/8f6f8f74de3069076b36134ad16fa8c865649476))
* **client:** allow binary returns ([#140](https://github.com/Increase/increase-go/issues/140)) ([01ba393](https://github.com/Increase/increase-go/commit/01ba39321d93e94fd3d7f349a35d5840a93d4d07))
...
* elaborate readme and improve doc comments ([d8b752d](https://github.com/Increase/increase-go/commit/d8b752d74db778ab0b839ea5faaa62fcd5d3fed6))
* fixes tests where an array has to have unique enum values ([#87](https://github.com/Increase/increase-go/issues/87)) ([8b0fd3f](https://github.com/Increase/increase-go/commit/8b0fd3f244c4b07d52d11ae96e2b26b4b6292c4e))
...
* **github:** include a devcontainer setup ([#138](https://github.com/Increase/increase-go/issues/138)) ([ae80c79](https://github.com/Increase/increase-go/commit/ae80c7945d1f70517e15976f435ad836d12cc284))
...
* improve retry behavior on context deadline ([#106](https://github.com/Increase/increase-go/issues/106)) ([589367a](https://github.com/Increase/increase-go/commit/589367a6169823a1701b5ccbc53c04b17903a0ef))
* **internal:** fallback to json serialization if no serialization methods are defined ([#153](https://github.com/Increase/increase-go/issues/153)) ([ec53bbd](https://github.com/Increase/increase-go/commit/ec53bbdde47bea0c1148364cf36a7efb07671d8f))
...
* retry on 408 Request Timeout ([#96](https://github.com/Increase/increase-go/issues/96)) ([8054f15](https://github.com/Increase/increase-go/commit/8054f15491c9c5077861fbcbc15124d55feee681))
...
* **api:** move ACH Return endpoint and add digital wallet properties ([#80](https://github.com/Increase/increase-go/issues/80)) ([46ce0d7](https://github.com/Increase/increase-go/commit/46ce0d7a02103758f0477fe321cffefce6de8361))
...
* **ci:** ignore stainless-app edits to release PR title ([#176](https://github.com/Increase/increase-go/issues/176)) ([a10dc02](https://github.com/Increase/increase-go/commit/a10dc025bee0cd43d398eb3334389e2b8ec93df1))
...
* **core:** add null check to prevent segfault when canceling context ([#90](https://github.com/Increase/increase-go/issues/90)) ([0a26d5e](https://github.com/Increase/increase-go/commit/0a26d5e2142c74a2cc6b7f7e63b4b51f1497bbc3))
* **core:** improve retry behavior and related docs ([#97](https://github.com/Increase/increase-go/issues/97)) ([fd56159](https://github.com/Increase/increase-go/commit/fd56159cafc55033288e52163e502cf405aa3f67))
...
* **docs:** change `Page` package to shared ([#103](https://github.com/Increase/increase-go/issues/103)) ([98454c4](https://github.com/Increase/increase-go/commit/98454c42660aee982240427dff2d647047390fdc))
* **docs:** correct pagination api.md link ([#191](https://github.com/Increase/increase-go/issues/191)) ([269dd65](https://github.com/Increase/increase-go/commit/269dd65315cd2f3f52e56077021fe929cfe564af))
...
* make options.WithHeader utils case-insensitive ([#143](https://github.com/Increase/increase-go/issues/143)) ([27c59d7](https://github.com/Increase/increase-go/commit/27c59d75f285cbd5cedc4014c4908239f9964819))
...
* prevent index out of range bug during auto-pagination ([#112](https://github.com/Increase/increase-go/issues/112)) ([f970396](https://github.com/Increase/increase-go/commit/f9703964595cf7ef36006f20da3eb62866a3bae8))
...
* stop sending default idempotency headers with GET requests ([#147](https://github.com/Increase/increase-go/issues/147)) ([b15bb4c](https://github.com/Increase/increase-go/commit/b15bb4c8cf1c1e6159d1fe929b553c7c5bcede49))
* **test:** avoid test failures when SKIP_MOCK_TESTS is not set ([#175](https://github.com/Increase/increase-go/issues/175)) ([b7efa24](https://github.com/Increase/increase-go/commit/b7efa24dbeced49c0f7fc0ed36211a7429f0f24b))
...
* fix oauth casing ([#178](https://github.com/Increase/increase-go/issues/178)) ([3e6b022](https://github.com/Increase/increase-go/commit/3e6b022aabe11b28e724d0542982cdb7c8ea3da9))
