...
//
// [README]: https://pkg.go.dev/github.com/Increase/increase-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.increase.com/")
}
...
func WithEnvironmentSandbox() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://sandbox.increase.com/")
}
