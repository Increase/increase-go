...
const (
	...
	EntityCorporationBeneficialOwnersIndividualIdentificationMethodSocialSecurityNumberLast4              EntityCorporationBeneficialOwnersIndividualIdentificationMethod = "social_security_number_last4"
...
const (
	...
	EntityJointIndividualsIdentificationMethodSocialSecurityNumberLast4              EntityJointIndividualsIdentificationMethod = "social_security_number_last4"
...
func (r EntityJointIndividualsIdentificationMethod) IsKnown() bool {
	switch r {
	case EntityJointIndividualsIdentificationMethodSocialSecurityNumber, EntityJointIndividualsIdentificationMethodSocialSecurityNumberLast4, EntityJointIndividualsIdentificationMethodIndividualTaxpayerIdentificationNumber, EntityJointIndividualsIdentificationMethodPassport, EntityJointIndividualsIdentificationMethodDriversLicense, EntityJointIndividualsIdentificationMethodOther:
		return true
	}
	return false
}
...
const (
	...
	EntityNaturalPersonIdentificationMethodSocialSecurityNumberLast4              EntityNaturalPersonIdentificationMethod = "social_security_number_last4"
...
func (r EntityNaturalPersonIdentificationMethod) IsKnown() bool {
	switch r {
	case EntityNaturalPersonIdentificationMethodSocialSecurityNumber, EntityNaturalPersonIdentificationMethodSocialSecurityNumberLast4, EntityNaturalPersonIdentificationMethodIndividualTaxpayerIdentificationNumber, EntityNaturalPersonIdentificationMethodPassport, EntityNaturalPersonIdentificationMethodDriversLicense, EntityNaturalPersonIdentificationMethodOther:
		return true
	}
	return false
}
...
const (
	...
	EntitySoleProprietorshipSoleProprietorIdentificationMethodSocialSecurityNumberLast4              EntitySoleProprietorshipSoleProprietorIdentificationMethod = "social_security_number_last4"
...
const (
	...
	EntityThirdPartyVerificationVendorTaktile EntityThirdPartyVerificationVendor = "taktile"
)

func (r EntityThirdPartyVerificationVendor) IsKnown() bool {
	switch r {
	case EntityThirdPartyVerificationVendorAlloy, EntityThirdPartyVerificationVendorMiddesk, EntityThirdPartyVerificationVendorOscilar, EntityThirdPartyVerificationVendorPersona, EntityThirdPartyVerificationVendorTaktile:
		return true
	}
	return false
}
...
const (
	...
	EntityTrustGrantorIdentificationMethodSocialSecurityNumberLast4              EntityTrustGrantorIdentificationMethod = "social_security_number_last4"
...
func (r EntityTrustGrantorIdentificationMethod) IsKnown() bool {
	switch r {
	case EntityTrustGrantorIdentificationMethodSocialSecurityNumber, EntityTrustGrantorIdentificationMethodSocialSecurityNumberLast4, EntityTrustGrantorIdentificationMethodIndividualTaxpayerIdentificationNumber, EntityTrustGrantorIdentificationMethodPassport, EntityTrustGrantorIdentificationMethodDriversLicense, EntityTrustGrantorIdentificationMethodOther:
		return true
	}
	return false
}
...
const (
	...
	EntityTrustTrusteesIndividualIdentificationMethodSocialSecurityNumberLast4              EntityTrustTrusteesIndividualIdentificationMethod = "social_security_number_last4"
...
const (
	...
	EntityNewParamsCorporationBeneficialOwnersIndividualIdentificationMethodSocialSecurityNumberLast4              EntityNewParamsCorporationBeneficialOwnersIndividualIdentificationMethod = "social_security_number_last4"
...
const (
	...
	EntityNewParamsThirdPartyVerificationVendorTaktile EntityNewParamsThirdPartyVerificationVendor = "taktile"
)

func (r EntityNewParamsThirdPartyVerificationVendor) IsKnown() bool {
	switch r {
	case EntityNewParamsThirdPartyVerificationVendorAlloy, EntityNewParamsThirdPartyVerificationVendorMiddesk, EntityNewParamsThirdPartyVerificationVendorOscilar, EntityNewParamsThirdPartyVerificationVendorPersona, EntityNewParamsThirdPartyVerificationVendorTaktile:
		return true
	}
	return false
}
...
const (
	...
	EntityUpdateParamsThirdPartyVerificationVendorTaktile EntityUpdateParamsThirdPartyVerificationVendor = "taktile"
)

func (r EntityUpdateParamsThirdPartyVerificationVendor) IsKnown() bool {
	switch r {
	case EntityUpdateParamsThirdPartyVerificationVendorAlloy, EntityUpdateParamsThirdPartyVerificationVendorMiddesk, EntityUpdateParamsThirdPartyVerificationVendorOscilar, EntityUpdateParamsThirdPartyVerificationVendorPersona, EntityUpdateParamsThirdPartyVerificationVendorTaktile:
		return true
	}
	return false
}
...
type EntityUpdateParamsTrust struct {
	...
	Grantor param.Field[EntityUpdateParamsTrustGrantor] `json:"grantor"`
	// The legal name of the trust.
	Name param.Field[string] `json:"name"`
	...
	Trustees param.Field[[]EntityUpdateParamsTrustTrustee] `json:"trustees"`
}
...
// The grantor of the trust. If you specify this parameter, the trust's existing
// grantor will be archived and replaced with the grantor you provide.
type EntityUpdateParamsTrustGrantor struct {
	// The grantor's physical address. Mail receiving locations like PO Boxes and PMB's
	// are disallowed.
	Address param.Field[EntityUpdateParamsTrustGrantorAddress] `json:"address" api:"required"`
	// The grantor's date of birth in YYYY-MM-DD format.
	DateOfBirth param.Field[time.Time] `json:"date_of_birth" api:"required" format:"date"`
	// A means of verifying the person's identity.
	Identification param.Field[EntityUpdateParamsTrustGrantorIdentification] `json:"identification" api:"required"`
	// The grantor's legal name.
	Name param.Field[string] `json:"name" api:"required"`
	// The identification method for an individual can only be a passport, driver's
	// license, or other document if you've confirmed the individual does not have a US
...
func (r EntityUpdateParamsTrustGrantor) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

// The grantor's physical address. Mail receiving locations like PO Boxes and PMB's
// are disallowed.
type EntityUpdateParamsTrustGrantorAddress struct {
	// The city, district, town, or village of the address.
	City param.Field[string] `json:"city" api:"required"`
	// The two-letter ISO 3166-1 alpha-2 code for the country of the address.
	//
...
func (r EntityUpdateParamsTrustGrantorAddress) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

// A means of verifying the person's identity.
type EntityUpdateParamsTrustGrantorIdentification struct {
	// A method that can be used to verify the individual's identity.
	//
	// Defaults to `social_security_number`.
	Method param.Field[EntityUpdateParamsTrustGrantorIdentificationMethod] `json:"method" api:"required"`
	// An identification number that can be used to verify the individual's identity,
	// such as a social security number. For Social Security Numbers and Individual
	// Taxpayer Identification Numbers, submit nine digits with no dashes or other
	// separators.
	...
	// Information about the United States driver's license used for identification.
	// Required if `method` is equal to `drivers_license`.
	DriversLicense param.Field[EntityUpdateParamsTrustGrantorIdentificationDriversLicense] `json:"drivers_license"`
	// Information about the identification document provided. Required if `method` is
	// equal to `other`.
	Other param.Field[EntityUpdateParamsTrustGrantorIdentificationOther] `json:"other"`
	// Information about the passport used for identification. Required if `method` is
	// equal to `passport`.
	Passport    param.Field[EntityUpdateParamsTrustGrantorIdentificationPassport] `json:"passport"`
	ExtraFields map[string]interface{}                                            `json:"-,extras"`
}

func (r EntityUpdateParamsTrustGrantorIdentification) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

// A method that can be used to verify the individual's identity.
type EntityUpdateParamsTrustGrantorIdentificationMethod string

const (
	EntityUpdateParamsTrustGrantorIdentificationMethodSocialSecurityNumber                   EntityUpdateParamsTrustGrantorIdentificationMethod = "social_security_number"
	EntityUpdateParamsTrustGrantorIdentificationMethodIndividualTaxpayerIdentificationNumber EntityUpdateParamsTrustGrantorIdentificationMethod = "individual_taxpayer_identification_number"
	EntityUpdateParamsTrustGrantorIdentificationMethodPassport                               EntityUpdateParamsTrustGrantorIdentificationMethod = "passport"
	EntityUpdateParamsTrustGrantorIdentificationMethodDriversLicense                         EntityUpdateParamsTrustGrantorIdentificationMethod = "drivers_license"
	EntityUpdateParamsTrustGrantorIdentificationMethodOther                                  EntityUpdateParamsTrustGrantorIdentificationMethod = "other"
)

func (r EntityUpdateParamsTrustGrantorIdentificationMethod) IsKnown() bool {
	switch r {
	case EntityUpdateParamsTrustGrantorIdentificationMethodSocialSecurityNumber, EntityUpdateParamsTrustGrantorIdentificationMethodIndividualTaxpayerIdentificationNumber, EntityUpdateParamsTrustGrantorIdentificationMethodPassport, EntityUpdateParamsTrustGrantorIdentificationMethodDriversLicense, EntityUpdateParamsTrustGrantorIdentificationMethodOther:
		return true
	}
	return false
}
...
// Information about the United States driver's license used for identification.
// Required if `method` is equal to `drivers_license`.
type EntityUpdateParamsTrustGrantorIdentificationDriversLicense struct {
	// The driver's license's expiration date in YYYY-MM-DD format.
	ExpirationDate param.Field[time.Time] `json:"expiration_date" api:"required" format:"date"`
	// The identifier of the File containing the front of the driver's license.
	FileID param.Field[string] `json:"file_id" api:"required"`
...
func (r EntityUpdateParamsTrustGrantorIdentificationDriversLicense) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

// Information about the identification document provided. Required if `method` is
// equal to `other`.
type EntityUpdateParamsTrustGrantorIdentificationOther struct {
	// The two-character ISO 3166-1 code representing the country that issued the
	// document (e.g., `US`).
	Country param.Field[string] `json:"country" api:"required"`
	// A description of the document submitted.
...
func (r EntityUpdateParamsTrustGrantorIdentificationOther) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

// Information about the passport used for identification. Required if `method` is
// equal to `passport`.
type EntityUpdateParamsTrustGrantorIdentificationPassport struct {
	// The two-character ISO 3166-1 code representing the country that issued the
	// document (e.g., `US`).
	Country param.Field[string] `json:"country" api:"required"`
	// The passport's expiration date in YYYY-MM-DD format.
...
func (r EntityUpdateParamsTrustGrantorIdentificationPassport) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

type EntityUpdateParamsTrustTrustee struct {
	// The structure of the trustee.
	Structure param.Field[EntityUpdateParamsTrustTrusteesStructure] `json:"structure" api:"required"`
	// Details of the individual trustee. Within the trustee object, this is required
	// if `structure` is equal to `individual`.
	Individual param.Field[EntityUpdateParamsTrustTrusteesIndividual] `json:"individual"`
}

func (r EntityUpdateParamsTrustTrustee) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

// The structure of the trustee.
type EntityUpdateParamsTrustTrusteesStructure string

const (
	EntityUpdateParamsTrustTrusteesStructureIndividual EntityUpdateParamsTrustTrusteesStructure = "individual"
)

func (r EntityUpdateParamsTrustTrusteesStructure) IsKnown() bool {
	switch r {
	case EntityUpdateParamsTrustTrusteesStructureIndividual:
		return true
	}
	return false
}
...
// Details of the individual trustee. Within the trustee object, this is required
// if `structure` is equal to `individual`.
type EntityUpdateParamsTrustTrusteesIndividual struct {
	// The individual's physical address. Mail receiving locations like PO Boxes and
	// PMB's are disallowed.
	Address param.Field[EntityUpdateParamsTrustTrusteesIndividualAddress] `json:"address" api:"required"`
	// The person's date of birth in YYYY-MM-DD format.
	DateOfBirth param.Field[time.Time] `json:"date_of_birth" api:"required" format:"date"`
	// A means of verifying the person's identity.
	Identification param.Field[EntityUpdateParamsTrustTrusteesIndividualIdentification] `json:"identification" api:"required"`
	// The person's legal name.
	Name param.Field[string] `json:"name" api:"required"`
	// The identification method for an individual can only be a passport, driver's
	// license, or other document if you've confirmed the individual does not have a US
...
func (r EntityUpdateParamsTrustTrusteesIndividual) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

// The individual's physical address. Mail receiving locations like PO Boxes and
// PMB's are disallowed.
type EntityUpdateParamsTrustTrusteesIndividualAddress struct {
	// The city, district, town, or village of the address.
	City param.Field[string] `json:"city" api:"required"`
	// The two-letter ISO 3166-1 alpha-2 code for the country of the address.
	//
...
func (r EntityUpdateParamsTrustTrusteesIndividualAddress) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

// A means of verifying the person's identity.
type EntityUpdateParamsTrustTrusteesIndividualIdentification struct {
	// A method that can be used to verify the individual's identity.
	//
	// Defaults to `social_security_number`.
	Method param.Field[EntityUpdateParamsTrustTrusteesIndividualIdentificationMethod] `json:"method" api:"required"`
	// An identification number that can be used to verify the individual's identity,
	// such as a social security number. For Social Security Numbers and Individual
	// Taxpayer Identification Numbers, submit nine digits with no dashes or other
	// separators.
	...
	// Information about the United States driver's license used for identification.
	// Required if `method` is equal to `drivers_license`.
	DriversLicense param.Field[EntityUpdateParamsTrustTrusteesIndividualIdentificationDriversLicense] `json:"drivers_license"`
	// Information about the identification document provided. Required if `method` is
	// equal to `other`.
	Other param.Field[EntityUpdateParamsTrustTrusteesIndividualIdentificationOther] `json:"other"`
	// Information about the passport used for identification. Required if `method` is
	// equal to `passport`.
	Passport    param.Field[EntityUpdateParamsTrustTrusteesIndividualIdentificationPassport] `json:"passport"`
	ExtraFields map[string]interface{}                                                       `json:"-,extras"`
}

func (r EntityUpdateParamsTrustTrusteesIndividualIdentification) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

// A method that can be used to verify the individual's identity.
type EntityUpdateParamsTrustTrusteesIndividualIdentificationMethod string

const (
	EntityUpdateParamsTrustTrusteesIndividualIdentificationMethodSocialSecurityNumber                   EntityUpdateParamsTrustTrusteesIndividualIdentificationMethod = "social_security_number"
	EntityUpdateParamsTrustTrusteesIndividualIdentificationMethodIndividualTaxpayerIdentificationNumber EntityUpdateParamsTrustTrusteesIndividualIdentificationMethod = "individual_taxpayer_identification_number"
	EntityUpdateParamsTrustTrusteesIndividualIdentificationMethodPassport                               EntityUpdateParamsTrustTrusteesIndividualIdentificationMethod = "passport"
	EntityUpdateParamsTrustTrusteesIndividualIdentificationMethodDriversLicense                         EntityUpdateParamsTrustTrusteesIndividualIdentificationMethod = "drivers_license"
	EntityUpdateParamsTrustTrusteesIndividualIdentificationMethodOther                                  EntityUpdateParamsTrustTrusteesIndividualIdentificationMethod = "other"
)

func (r EntityUpdateParamsTrustTrusteesIndividualIdentificationMethod) IsKnown() bool {
	switch r {
	case EntityUpdateParamsTrustTrusteesIndividualIdentificationMethodSocialSecurityNumber, EntityUpdateParamsTrustTrusteesIndividualIdentificationMethodIndividualTaxpayerIdentificationNumber, EntityUpdateParamsTrustTrusteesIndividualIdentificationMethodPassport, EntityUpdateParamsTrustTrusteesIndividualIdentificationMethodDriversLicense, EntityUpdateParamsTrustTrusteesIndividualIdentificationMethodOther:
		return true
	}
	return false
}
...
// Information about the United States driver's license used for identification.
// Required if `method` is equal to `drivers_license`.
type EntityUpdateParamsTrustTrusteesIndividualIdentificationDriversLicense struct {
	// The driver's license's expiration date in YYYY-MM-DD format.
	ExpirationDate param.Field[time.Time] `json:"expiration_date" api:"required" format:"date"`
	// The identifier of the File containing the front of the driver's license.
	FileID param.Field[string] `json:"file_id" api:"required"`
...
func (r EntityUpdateParamsTrustTrusteesIndividualIdentificationDriversLicense) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

// Information about the identification document provided. Required if `method` is
// equal to `other`.
type EntityUpdateParamsTrustTrusteesIndividualIdentificationOther struct {
	// The two-character ISO 3166-1 code representing the country that issued the
	// document (e.g., `US`).
	Country param.Field[string] `json:"country" api:"required"`
	// A description of the document submitted.
...
func (r EntityUpdateParamsTrustTrusteesIndividualIdentificationOther) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

// Information about the passport used for identification. Required if `method` is
// equal to `passport`.
type EntityUpdateParamsTrustTrusteesIndividualIdentificationPassport struct {
	// The two-character ISO 3166-1 code representing the country that issued the
	// document (e.g., `US`).
	Country param.Field[string] `json:"country" api:"required"`
	// The passport's expiration date in YYYY-MM-DD format.
...
func (r EntityUpdateParamsTrustTrusteesIndividualIdentificationPassport) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}
