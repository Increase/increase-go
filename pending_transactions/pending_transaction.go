...
type PendingTransaction struct {
	...
	Source *PendingTransactionSource `json:"source,omitempty"`
...
// Transaction's currency. This will match the currency on the Pending
// Transcation's Account.
func (r *PendingTransaction) GetCurrency() (Currency string) {
...
// Whether the Pending Transaction has been confirmed and has an associated
// Transaction.
func (r *PendingTransaction) GetStatus() (Status string) {
...
// A constant representing the object's type. For this resource it will always be
// `pending_transaction`.
func (r *PendingTransaction) GetType() (Type string) {
	if r != nil && r.Type != nil {
		Type = *r.Type
	}
	return
