...
type SimulationService struct {
	...
	AccountRevenuePayments           *SimulationAccountRevenuePaymentService
	...
	CardAuthentications              *SimulationCardAuthenticationService
	CardPurchaseSupplements          *SimulationCardPurchaseSupplementService
	...
	Exports                          *SimulationExportService
...
func NewSimulationService(opts ...option.RequestOption) (r *SimulationService) {
	...
	r.AccountRevenuePayments = NewSimulationAccountRevenuePaymentService(opts...)
	...
	r.CardAuthentications = NewSimulationCardAuthenticationService(opts...)
	r.CardPurchaseSupplements = NewSimulationCardPurchaseSupplementService(opts...)
	...
	r.WireDrawdownRequests = NewSimulationWireDrawdownRequestService(opts...)
	...
	r.Exports = NewSimulationExportService(opts...)
