...
func TestSimulationInboundFednowTransferNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Simulations.InboundFednowTransfers.New(context.TODO(), increase.SimulationInboundFednowTransferNewParams{
