...
func (r PendingTransactionSourceCardAuthorizationProcessingCategory) IsKnown() bool {
	switch r {
	case PendingTransactionSourceCardAuthorizationProcessingCategoryAccountFunding, PendingTransactionSourceCardAuthorizationProcessingCategoryAutomaticFuelDispenser, PendingTransactionSourceCardAuthorizationProcessingCategoryBillPayment, PendingTransactionSourceCardAuthorizationProcessingCategoryOriginalCredit, PendingTransactionSourceCardAuthorizationProcessingCategoryPurchase, PendingTransactionSourceCardAuthorizationProcessingCategoryQuasiCash, PendingTransactionSourceCardAuthorizationProcessingCategoryRefund, PendingTransactionSourceCardAuthorizationProcessingCategoryCashDisbursement, PendingTransactionSourceCardAuthorizationProcessingCategoryUnknown:
		return true
	}
	return false
}
