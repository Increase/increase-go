...
const (
	...
	InboundCheckDepositDepositReturnReasonReferToMaker         InboundCheckDepositDepositReturnReason = "refer_to_maker"
)

func (r InboundCheckDepositDepositReturnReason) IsKnown() bool {
	switch r {
	case InboundCheckDepositDepositReturnReasonAlteredOrFictitious, InboundCheckDepositDepositReturnReasonNotAuthorized, InboundCheckDepositDepositReturnReasonDuplicatePresentment, InboundCheckDepositDepositReturnReasonEndorsementMissing, InboundCheckDepositDepositReturnReasonEndorsementIrregular, InboundCheckDepositDepositReturnReasonReferToMaker:
		return true
	}
	return false
}
...
const (
	...
	InboundCheckDepositReturnParamsReasonReferToMaker         InboundCheckDepositReturnParamsReason = "refer_to_maker"
)

func (r InboundCheckDepositReturnParamsReason) IsKnown() bool {
	switch r {
	case InboundCheckDepositReturnParamsReasonAlteredOrFictitious, InboundCheckDepositReturnParamsReasonNotAuthorized, InboundCheckDepositReturnParamsReasonDuplicatePresentment, InboundCheckDepositReturnParamsReasonEndorsementMissing, InboundCheckDepositReturnParamsReasonEndorsementIrregular, InboundCheckDepositReturnParamsReasonReferToMaker:
		return true
	}
	return false
}
