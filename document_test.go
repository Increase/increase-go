...
func TestDocumentGet(t *testing.T) {
	...
	_, err := c.Documents.Get(context.TODO(), "document_qjtqc6s4c14ve2q89izm")
	if err != nil {
...
func TestDocumentListWithOptionalParams(t *testing.T) {
	...
	_, err := c.Documents.List(context.TODO(), increase.DocumentListParams{
		...
		CreatedAt: increase.F(increase.DocumentListParamsCreatedAt{After: increase.F(time.Now()), Before: increase.F(time.Now()), OnOrAfter: increase.F(time.Now()), OnOrBefore: increase.F(time.Now())}),
