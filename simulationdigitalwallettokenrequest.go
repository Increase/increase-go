...
const (
	...
	SimulationDigitalWalletTokenRequestNewResponseDeclineReasonIncorrectCardVerificationCode SimulationDigitalWalletTokenRequestNewResponseDeclineReason = "incorrect_card_verification_code"
	SimulationDigitalWalletTokenRequestNewResponseDeclineReasonDeclinedByTokenRequestor      SimulationDigitalWalletTokenRequestNewResponseDeclineReason = "declined_by_token_requestor"
	SimulationDigitalWalletTokenRequestNewResponseDeclineReasonGroupLocked                   SimulationDigitalWalletTokenRequestNewResponseDeclineReason = "group_locked"
	SimulationDigitalWalletTokenRequestNewResponseDeclineReasonAccountClosed                 SimulationDigitalWalletTokenRequestNewResponseDeclineReason = "account_closed"
	SimulationDigitalWalletTokenRequestNewResponseDeclineReasonEntityNotActive               SimulationDigitalWalletTokenRequestNewResponseDeclineReason = "entity_not_active"
)

func (r SimulationDigitalWalletTokenRequestNewResponseDeclineReason) IsKnown() bool {
	switch r {
	case SimulationDigitalWalletTokenRequestNewResponseDeclineReasonCardNotActive, SimulationDigitalWalletTokenRequestNewResponseDeclineReasonNoVerificationMethod, SimulationDigitalWalletTokenRequestNewResponseDeclineReasonWebhookTimedOut, SimulationDigitalWalletTokenRequestNewResponseDeclineReasonWebhookDeclined, SimulationDigitalWalletTokenRequestNewResponseDeclineReasonIncorrectCardVerificationCode, SimulationDigitalWalletTokenRequestNewResponseDeclineReasonDeclinedByTokenRequestor, SimulationDigitalWalletTokenRequestNewResponseDeclineReasonGroupLocked, SimulationDigitalWalletTokenRequestNewResponseDeclineReasonAccountClosed, SimulationDigitalWalletTokenRequestNewResponseDeclineReasonEntityNotActive:
		return true
	}
	return false
}
