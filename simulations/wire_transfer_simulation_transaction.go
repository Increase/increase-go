...
type WireTransferSimulationTransaction struct {
	...
	Source *InboundWireTransferSimulationResultTransactionSource `json:"source,omitempty"`
...
// Transaction's currency. This will match the currency on the Transcation's
// Account.
func (r *WireTransferSimulationTransaction) GetCurrency() (Currency string) {
...
// undocumented keys may appear in this object. These should be treated as
// deprecated and will be removed in the future.
func (r *WireTransferSimulationTransaction) GetSource() (Source InboundWireTransferSimulationResultTransactionSource) {
...
// A constant representing the object's type. For this resource it will always be
// `transaction`.
func (r *WireTransferSimulationTransaction) GetType() (Type string) {
	if r != nil && r.Type != nil {
		Type = *r.Type
	}
	return
