...
type CardAuthorizationSimulationDeclinedTransaction struct {
	...
	Source *InboundCardAuthorizationSimulationResultDeclinedTransactionSource `json:"source,omitempty"`
...
// Transaction's currency. This will match the currency on the Declined
// Transcation's Account.
func (r *CardAuthorizationSimulationDeclinedTransaction) GetCurrency() (Currency string) {
...
// additional undocumented keys may appear in this object. These should be treated
// as deprecated and will be removed in the future.
func (r *CardAuthorizationSimulationDeclinedTransaction) GetSource() (Source InboundCardAuthorizationSimulationResultDeclinedTransactionSource) {
...
// A constant representing the object's type. For this resource it will always be
// `declined_transaction`.
func (r *CardAuthorizationSimulationDeclinedTransaction) GetType() (Type string) {
	if r != nil && r.Type != nil {
		Type = *r.Type
	}
	return
