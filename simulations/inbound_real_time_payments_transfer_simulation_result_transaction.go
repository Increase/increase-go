...
type InboundRealTimePaymentsTransferSimulationResultTransaction struct {
	...
	Source *InboundRealTimePaymentsTransferSimulationResultTransactionSource `json:"source,omitempty"`
...
// Transaction's currency. This will match the currency on the Transcation's
// Account.
func (r *InboundRealTimePaymentsTransferSimulationResultTransaction) GetCurrency() (Currency string) {
...
// A constant representing the object's type. For this resource it will always be
// `transaction`.
func (r *InboundRealTimePaymentsTransferSimulationResultTransaction) GetType() (Type string) {
	if r != nil && r.Type != nil {
		Type = *r.Type
	}
	return
