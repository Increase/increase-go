...
type ACHTransferSimulationDeclinedTransaction struct {
	...
	Source *InboundACHTransferSimulationResultDeclinedTransactionSource `json:"source,omitempty"`
...
// Transaction's currency. This will match the currency on the Declined
// Transcation's Account.
func (r *ACHTransferSimulationDeclinedTransaction) GetCurrency() (Currency string) {
...
// additional undocumented keys may appear in this object. These should be treated
// as deprecated and will be removed in the future.
func (r *ACHTransferSimulationDeclinedTransaction) GetSource() (Source InboundACHTransferSimulationResultDeclinedTransactionSource) {
...
// A constant representing the object's type. For this resource it will always be
// `declined_transaction`.
func (r *ACHTransferSimulationDeclinedTransaction) GetType() (Type string) {
	if r != nil && r.Type != nil {
		Type = *r.Type
	}
	return
