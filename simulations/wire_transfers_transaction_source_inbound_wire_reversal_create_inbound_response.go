...
type WireTransfersTransactionSourceInboundWireReversalCreateInboundResponse struct {
...
// The amount that was reversed.
func (r *WireTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetAmount() (Amount int64) {
...
// The description on the reversal message from Fedwire.
func (r *WireTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetDescription() (Description string) {
...
// The Fedwire cycle date for the wire reversal.
func (r *WireTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetInputCycleDate() (InputCycleDate string) {
...
// The Fedwire sequence number.
func (r *WireTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetInputSequenceNumber() (InputSequenceNumber string) {
...
// The Fedwire input source identifier.
func (r *WireTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetInputSource() (InputSource string) {
...
// The Fedwire transaction identifier.
func (r *WireTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetInputMessageAccountabilityData() (InputMessageAccountabilityData string) {
...
// The Fedwire transaction identifier for the wire transfer that was reversed.
func (r *WireTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetPreviousMessageInputMessageAccountabilityData() (PreviousMessageInputMessageAccountabilityData string) {
...
// The Fedwire cycle date for the wire transfer that was reversed.
func (r *WireTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetPreviousMessageInputCycleDate() (PreviousMessageInputCycleDate string) {
...
// The Fedwire sequence number for the wire transfer that was reversed.
func (r *WireTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetPreviousMessageInputSequenceNumber() (PreviousMessageInputSequenceNumber string) {
...
// The Fedwire input source identifier for the wire transfer that was reversed.
func (r *WireTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetPreviousMessageInputSource() (PreviousMessageInputSource string) {
...
// Information included in the wire reversal for the receiving financial
// institution.
func (r *WireTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetReceiverFinancialInstitutionInformation() (ReceiverFinancialInstitutionInformation string) {
...
// Additional financial institution information included in the wire reversal.
func (r *WireTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetFinancialInstitutionToFinancialInstitutionInformation() (FinancialInstitutionToFinancialInstitutionInformation string) {
