...
type ACHTransfersTransactionSourceInboundWireReversalCreateInboundResponse struct {
...
// The amount that was reversed.
func (r *ACHTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetAmount() (Amount int64) {
...
// The description on the reversal message from Fedwire.
func (r *ACHTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetDescription() (Description string) {
...
// The Fedwire cycle date for the wire reversal.
func (r *ACHTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetInputCycleDate() (InputCycleDate string) {
...
// The Fedwire sequence number.
func (r *ACHTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetInputSequenceNumber() (InputSequenceNumber string) {
...
// The Fedwire input source identifier.
func (r *ACHTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetInputSource() (InputSource string) {
...
// The Fedwire transaction identifier.
func (r *ACHTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetInputMessageAccountabilityData() (InputMessageAccountabilityData string) {
...
// The Fedwire transaction identifier for the wire transfer that was reversed.
func (r *ACHTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetPreviousMessageInputMessageAccountabilityData() (PreviousMessageInputMessageAccountabilityData string) {
...
// The Fedwire cycle date for the wire transfer that was reversed.
func (r *ACHTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetPreviousMessageInputCycleDate() (PreviousMessageInputCycleDate string) {
...
// The Fedwire sequence number for the wire transfer that was reversed.
func (r *ACHTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetPreviousMessageInputSequenceNumber() (PreviousMessageInputSequenceNumber string) {
...
// The Fedwire input source identifier for the wire transfer that was reversed.
func (r *ACHTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetPreviousMessageInputSource() (PreviousMessageInputSource string) {
...
// Information included in the wire reversal for the receiving financial
// institution.
func (r *ACHTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetReceiverFinancialInstitutionInformation() (ReceiverFinancialInstitutionInformation string) {
...
// Additional financial institution information included in the wire reversal.
func (r *ACHTransfersTransactionSourceInboundWireReversalCreateInboundResponse) GetFinancialInstitutionToFinancialInstitutionInformation() (FinancialInstitutionToFinancialInstitutionInformation string) {
