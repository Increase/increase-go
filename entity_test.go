		...
		increase.EntityUpdateParams{
			...
			Trust: increase.F(increase.EntityUpdateParamsTrust{
				...
				Grantor: increase.F(increase.EntityUpdateParamsTrustGrantor{
					...
					DateOfBirth: increase.F(time.Now()),
					Identification: increase.F(increase.EntityUpdateParamsTrustGrantorIdentification{
						Method: increase.F(increase.EntityUpdateParamsTrustGrantorIdentificationMethodSocialSecurityNumber),
						Number: increase.F("xxxx"),
						DriversLicense: increase.F(increase.EntityUpdateParamsTrustGrantorIdentificationDriversLicense{
							ExpirationDate: increase.F(time.Now()),
							FileID:         increase.F("file_id"),
							State:          increase.F("xx"),
							BackFileID:     increase.F("back_file_id"),
						}),
						Other: increase.F(increase.EntityUpdateParamsTrustGrantorIdentificationOther{
							Country:        increase.F("x"),
							Description:    increase.F("x"),
							FileID:         increase.F("file_id"),
							BackFileID:     increase.F("back_file_id"),
						...
						Passport: increase.F(increase.EntityUpdateParamsTrustGrantorIdentificationPassport{
							Country:        increase.F("x"),
							ExpirationDate: increase.F(time.Now()),
							FileID:         increase.F("file_id"),
						}),
				...
				Name: increase.F("x"),
				Trustees: increase.F([]increase.EntityUpdateParamsTrustTrustee{{
					Structure: increase.F(increase.EntityUpdateParamsTrustTrusteesStructureIndividual),
					Individual: increase.F(increase.EntityUpdateParamsTrustTrusteesIndividual{
						Address: increase.F(increase.EntityUpdateParamsTrustTrusteesIndividualAddress{
							City:    increase.F("x"),
							Country: increase.F("x"),
							Line1:   increase.F("x"),
							Line2:   increase.F("x"),
						...
						DateOfBirth: increase.F(time.Now()),
						Identification: increase.F(increase.EntityUpdateParamsTrustTrusteesIndividualIdentification{
							Method: increase.F(increase.EntityUpdateParamsTrustTrusteesIndividualIdentificationMethodSocialSecurityNumber),
							Number: increase.F("xxxx"),
							DriversLicense: increase.F(increase.EntityUpdateParamsTrustTrusteesIndividualIdentificationDriversLicense{
								ExpirationDate: increase.F(time.Now()),
								FileID:         increase.F("file_id"),
								State:          increase.F("xx"),
								BackFileID:     increase.F("back_file_id"),
							}),
							Other: increase.F(increase.EntityUpdateParamsTrustTrusteesIndividualIdentificationOther{
								Country:        increase.F("x"),
								Description:    increase.F("x"),
								FileID:         increase.F("file_id"),
								BackFileID:     increase.F("back_file_id"),
							...
							Passport: increase.F(increase.EntityUpdateParamsTrustTrusteesIndividualIdentificationPassport{
								Country:        increase.F("x"),
								ExpirationDate: increase.F(time.Now()),
								FileID:         increase.F("file_id"),
							}),
...
func TestEntityListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Entities.List(context.TODO(), increase.EntityListParams{
		...
		ValidationStatus: increase.F(increase.EntityListParamsValidationStatus{
			In: increase.F([]increase.EntityListParamsValidationStatusIn{increase.EntityListParamsValidationStatusInPending}),
		}),
	})
	if err != nil {
		var apierr *increase.Error
