...
// transfer's currency. This will always be "USD" for a Real Time Payments
// transfer.
func (r *DeclinedTransactionSourceInboundRealTimePaymentsTransferDecline) GetCurrency() (Currency string) {
...
// Why the transfer was declined.
func (r *DeclinedTransactionSourceInboundRealTimePaymentsTransferDecline) GetReason() (Reason string) {
