...
type TransactionsSourceInboundACHTransferRetrieveResponse struct {
...
// The declined amount in the minor unit of the destination account currency. For
// dollars, for example, this is cents.
func (r *TransactionsSourceInboundACHTransferRetrieveResponse) GetAmount() (Amount int64) {
...
func (r *TransactionsSourceInboundACHTransferRetrieveResponse) GetOriginatorCompanyName() (OriginatorCompanyName string) {
...
func (r *TransactionsSourceInboundACHTransferRetrieveResponse) GetOriginatorCompanyDescriptiveDate() (OriginatorCompanyDescriptiveDate string) {
...
func (r *TransactionsSourceInboundACHTransferRetrieveResponse) GetOriginatorCompanyDiscretionaryData() (OriginatorCompanyDiscretionaryData string) {
...
func (r *TransactionsSourceInboundACHTransferRetrieveResponse) GetOriginatorCompanyEntryDescription() (OriginatorCompanyEntryDescription string) {
...
func (r *TransactionsSourceInboundACHTransferRetrieveResponse) GetOriginatorCompanyId() (OriginatorCompanyId string) {
...
func (r *TransactionsSourceInboundACHTransferRetrieveResponse) GetReceiverIdNumber() (ReceiverIdNumber string) {
...
func (r *TransactionsSourceInboundACHTransferRetrieveResponse) GetReceiverName() (ReceiverName string) {
...
func (r *TransactionsSourceInboundACHTransferRetrieveResponse) GetTraceNumber() (TraceNumber string) {
