...
type TransactionsSourceInboundWireTransferRetrieveResponse struct {
...
// The amount in the minor unit of the transaction's currency. For dollars, for
// example, this is cents.
func (r *TransactionsSourceInboundWireTransferRetrieveResponse) GetAmount() (Amount int64) {
...
func (r *TransactionsSourceInboundWireTransferRetrieveResponse) GetBeneficiaryAddressLine1() (BeneficiaryAddressLine1 string) {
...
func (r *TransactionsSourceInboundWireTransferRetrieveResponse) GetBeneficiaryAddressLine2() (BeneficiaryAddressLine2 string) {
...
func (r *TransactionsSourceInboundWireTransferRetrieveResponse) GetBeneficiaryAddressLine3() (BeneficiaryAddressLine3 string) {
...
func (r *TransactionsSourceInboundWireTransferRetrieveResponse) GetBeneficiaryName() (BeneficiaryName string) {
...
func (r *TransactionsSourceInboundWireTransferRetrieveResponse) GetBeneficiaryReference() (BeneficiaryReference string) {
...
func (r *TransactionsSourceInboundWireTransferRetrieveResponse) GetDescription() (Description string) {
...
func (r *TransactionsSourceInboundWireTransferRetrieveResponse) GetInputMessageAccountabilityData() (InputMessageAccountabilityData string) {
...
func (r *TransactionsSourceInboundWireTransferRetrieveResponse) GetOriginatorAddressLine1() (OriginatorAddressLine1 string) {
...
func (r *TransactionsSourceInboundWireTransferRetrieveResponse) GetOriginatorAddressLine2() (OriginatorAddressLine2 string) {
...
func (r *TransactionsSourceInboundWireTransferRetrieveResponse) GetOriginatorAddressLine3() (OriginatorAddressLine3 string) {
...
func (r *TransactionsSourceInboundWireTransferRetrieveResponse) GetOriginatorName() (OriginatorName string) {
...
func (r *TransactionsSourceInboundWireTransferRetrieveResponse) GetOriginatorToBeneficiaryInformation() (OriginatorToBeneficiaryInformation string) {
