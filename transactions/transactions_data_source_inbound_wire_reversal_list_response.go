...
type TransactionsDataSourceInboundWireReversalListResponse struct {
...
// The amount that was reversed.
func (r *TransactionsDataSourceInboundWireReversalListResponse) GetAmount() (Amount int64) {
...
// The description on the reversal message from Fedwire.
func (r *TransactionsDataSourceInboundWireReversalListResponse) GetDescription() (Description string) {
...
// The Fedwire cycle date for the wire reversal.
func (r *TransactionsDataSourceInboundWireReversalListResponse) GetInputCycleDate() (InputCycleDate string) {
...
// The Fedwire sequence number.
func (r *TransactionsDataSourceInboundWireReversalListResponse) GetInputSequenceNumber() (InputSequenceNumber string) {
...
// The Fedwire input source identifier.
func (r *TransactionsDataSourceInboundWireReversalListResponse) GetInputSource() (InputSource string) {
...
// The Fedwire transaction identifier.
func (r *TransactionsDataSourceInboundWireReversalListResponse) GetInputMessageAccountabilityData() (InputMessageAccountabilityData string) {
...
// The Fedwire transaction identifier for the wire transfer that was reversed.
func (r *TransactionsDataSourceInboundWireReversalListResponse) GetPreviousMessageInputMessageAccountabilityData() (PreviousMessageInputMessageAccountabilityData string) {
...
// The Fedwire cycle date for the wire transfer that was reversed.
func (r *TransactionsDataSourceInboundWireReversalListResponse) GetPreviousMessageInputCycleDate() (PreviousMessageInputCycleDate string) {
...
// The Fedwire sequence number for the wire transfer that was reversed.
func (r *TransactionsDataSourceInboundWireReversalListResponse) GetPreviousMessageInputSequenceNumber() (PreviousMessageInputSequenceNumber string) {
...
// The Fedwire input source identifier for the wire transfer that was reversed.
func (r *TransactionsDataSourceInboundWireReversalListResponse) GetPreviousMessageInputSource() (PreviousMessageInputSource string) {
...
// Information included in the wire reversal for the receiving financial
// institution.
func (r *TransactionsDataSourceInboundWireReversalListResponse) GetReceiverFinancialInstitutionInformation() (ReceiverFinancialInstitutionInformation string) {
...
// Additional financial institution information included in the wire reversal.
func (r *TransactionsDataSourceInboundWireReversalListResponse) GetFinancialInstitutionToFinancialInstitutionInformation() (FinancialInstitutionToFinancialInstitutionInformation string) {
