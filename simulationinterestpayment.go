...
const (
	...
	InterestPaymentSimulationResultTransactionSourceCategoryInboundWireTransferReversal InterestPaymentSimulationResultTransactionSourceCategory = "inbound_wire_transfer_reversal"
