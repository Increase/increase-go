...
const (
	...
	InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReasonAlteredOrFictitiousItem InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReason = "altered_or_fictitious_item"
	// The account this check is drawn on is frozen.
	InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReasonFrozenOrBlockedAccount InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReason = "frozen_or_blocked_account"
	// The check is post dated.
	InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReasonPostDated InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReason = "post_dated"
	// The endorsement was missing.
	InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReasonEndorsementMissing InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReason = "endorsement_missing"
	// The check signature was missing.
	InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReasonSignatureMissing InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReason = "signature_missing"
	// The bank suspects a stop payment will be placed.
	InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReasonStopPaymentSuspect InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReason = "stop_payment_suspect"
	// The bank cannot read the image.
	InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReasonUnusableImage InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReason = "unusable_image"
	// The check image fails the bank's security check.
	InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReasonImageFailsSecurityCheck InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReason = "image_fails_security_check"
	// The bank cannot determine the amount.
	InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReasonCannotDetermineAmount InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReason = "cannot_determine_amount"
	// The signature is inconsistent with prior signatures.
	InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReasonSignatureIrregular InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReason = "signature_irregular"
	// The check is a non-cash item and cannot be drawn against the account.
	InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReasonNonCashItem InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReason = "non_cash_item"
	// The bank is unable to process this check.
	InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReasonUnableToProcess InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReason = "unable_to_process"
	// The check exceeds the bank or customer's limit.
	InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReasonItemExceedsDollarLimit InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReason = "item_exceeds_dollar_limit"
	// The bank sold this account and no longer services this customer.
	InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReasonBranchOrAccountSold InterestPaymentSimulationResultTransactionSourceCheckDepositReturnReturnReason = "branch_or_account_sold"
)
...
type InterestPaymentSimulationResultTransactionSourceInboundACHTransfer struct {
	...
	Addenda InterestPaymentSimulationResultTransactionSourceInboundACHTransferAddenda `json:"addenda,required,nullable"`
...
// Additional information sent from the originator.
type InterestPaymentSimulationResultTransactionSourceInboundACHTransferAddenda struct {
	// The type of addendum.
	Category InterestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaCategory `json:"category,required"`
	// Unstructured `payment_related_information` passed through by the originator.
	Freeform InterestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaFreeform `json:"freeform,required,nullable"`
	JSON     interestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaJSON     `json:"-"`
}

// interestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaJSON
// contains the JSON metadata for the struct
// [InterestPaymentSimulationResultTransactionSourceInboundACHTransferAddenda]
type interestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaJSON struct {
	Category    apijson.Field
...
func (r *InterestPaymentSimulationResultTransactionSourceInboundACHTransferAddenda) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

// The type of addendum.
type InterestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaCategory string

const (
	// Unstructured addendum.
	InterestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaCategoryFreeform InterestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaCategory = "freeform"
)

// Unstructured `payment_related_information` passed through by the originator.
type InterestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaFreeform struct {
	// Each entry represents an addendum received from the originator.
	Entries []InterestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaFreeformEntry `json:"entries,required"`
	JSON    interestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaFreeformJSON    `json:"-"`
}

// interestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaFreeformJSON
// contains the JSON metadata for the struct
// [InterestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaFreeform]
type interestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaFreeformJSON struct {
	Entries     apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
}

func (r *InterestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaFreeform) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

type InterestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaFreeformEntry struct {
	// The payment related information passed in the addendum.
	PaymentRelatedInformation string                                                                                     `json:"payment_related_information,required"`
	JSON                      interestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaFreeformEntryJSON `json:"-"`
}

// interestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaFreeformEntryJSON
// contains the JSON metadata for the struct
// [InterestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaFreeformEntry]
type interestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaFreeformEntryJSON struct {
	PaymentRelatedInformation apijson.Field
	raw                       string
	ExtraFields               map[string]apijson.Field
}

func (r *InterestPaymentSimulationResultTransactionSourceInboundACHTransferAddendaFreeformEntry) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}
...
type InterestPaymentSimulationResultTransactionSourceInboundWireTransfer struct {
	...
	Type InterestPaymentSimulationResultTransactionSourceInboundWireTransferType `json:"type,required"`
...
// A constant representing the object's type. For this resource it will always be
// `inbound_wire_transfer`.
type InterestPaymentSimulationResultTransactionSourceInboundWireTransferType string

const (
	InterestPaymentSimulationResultTransactionSourceInboundWireTransferTypeInboundWireTransfer InterestPaymentSimulationResultTransactionSourceInboundWireTransferType = "inbound_wire_transfer"
)
