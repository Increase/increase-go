...
type CardsDigitalWalletUpdateParams struct {
...
// An email address that can be used to verify the cardholder via one-time passcode
// over email.
func (r *CardsDigitalWalletUpdateParams) GetEmail() (Email string) {
...
// A phone number that can be used to verify the cardholder via one-time passcode
// over SMS.
func (r *CardsDigitalWalletUpdateParams) GetPhone() (Phone string) {
...
// The card profile assigned to this digital card. Card profiles may also be
// assigned at the program level.
func (r *CardsDigitalWalletUpdateParams) GetCardProfileId() (CardProfileId string) {
