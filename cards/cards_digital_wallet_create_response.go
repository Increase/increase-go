...
type CardsDigitalWalletCreateResponse struct {
...
// An email address that can be used to verify the cardholder via one-time passcode
// over email.
func (r *CardsDigitalWalletCreateResponse) GetEmail() (Email string) {
...
// A phone number that can be used to verify the cardholder via one-time passcode
// over SMS.
func (r *CardsDigitalWalletCreateResponse) GetPhone() (Phone string) {
...
// The card profile assigned to this digital card. Card profiles may also be
// assigned at the program level.
func (r *CardsDigitalWalletCreateResponse) GetCardProfileId() (CardProfileId string) {
