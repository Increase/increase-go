...
func (r *IntrafiExclusionService) List(ctx context.Context, query IntrafiExclusionListParams, opts ...option.RequestOption) (res *IntrafiExclusionListResponse, err error) {
	opts = slices.Concat(r.Options, opts)
	path := "intrafi_exclusions"
...
type IntrafiExclusionListResponse struct {
	// The contents of the list.
	Data []IntrafiExclusion `json:"data,required"`
	// A pointer to a place in the list.
	NextCursor  string                           `json:"next_cursor,required,nullable"`
	ExtraFields map[string]interface{}           `json:"-,extras"`
	JSON        intrafiExclusionListResponseJSON `json:"-"`
}

// intrafiExclusionListResponseJSON contains the JSON metadata for the struct
// [IntrafiExclusionListResponse]
type intrafiExclusionListResponseJSON struct {
	Data        apijson.Field
...
func (r *IntrafiExclusionListResponse) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r intrafiExclusionListResponseJSON) RawJSON() string {
	return r.raw
}
