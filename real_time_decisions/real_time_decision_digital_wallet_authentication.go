...
// Whether your application successfully delivered the one-time passcode.
func (r *RealTimeDecisionDigitalWalletAuthentication) GetResult() (Result string) {
...
// The digital wallet app being used.
func (r *RealTimeDecisionDigitalWalletAuthentication) GetDigitalWallet() (DigitalWallet string) {
...
// The channel to send the card user their one-time passcode.
func (r *RealTimeDecisionDigitalWalletAuthentication) GetChannel() (Channel string) {
