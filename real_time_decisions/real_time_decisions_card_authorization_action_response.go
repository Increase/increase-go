...
type RealTimeDecisionsCardAuthorizationActionResponse struct {
...
// Whether or not the authorization was approved.
func (r *RealTimeDecisionsCardAuthorizationActionResponse) GetDecision() (Decision string) {
...
// The identifier of the Card that is being authorized.
func (r *RealTimeDecisionsCardAuthorizationActionResponse) GetCardId() (CardId string) {
...
// The identifier of the Account the authorization will debit.
func (r *RealTimeDecisionsCardAuthorizationActionResponse) GetAccountId() (AccountId string) {
...
// the time of purchase, in the minor unit of that currency. For dollars, for
// example, this is cents.
func (r *RealTimeDecisionsCardAuthorizationActionResponse) GetPresentmentAmount() (PresentmentAmount int64) {
...
// The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the currency the
// user sees at the time of purchase.
func (r *RealTimeDecisionsCardAuthorizationActionResponse) GetPresentmentCurrency() (PresentmentCurrency string) {
...
// The amount of the attempted authorization in the currency it will be settled in.
// This currency is the same as that of the Account the card belongs to.
func (r *RealTimeDecisionsCardAuthorizationActionResponse) GetSettlementAmount() (SettlementAmount int64) {
...
// The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the currency the
// transaction will be settled in.
func (r *RealTimeDecisionsCardAuthorizationActionResponse) GetSettlementCurrency() (SettlementCurrency string) {
...
// The Merchant Category Code (commonly abbreviated as MCC) of the merchant the
// card is transacting with.
func (r *RealTimeDecisionsCardAuthorizationActionResponse) GetMerchantCategoryCode() (MerchantCategoryCode string) {
...
// The merchant descriptor of the merchant the card is transacting with.
func (r *RealTimeDecisionsCardAuthorizationActionResponse) GetMerchantDescriptor() (MerchantDescriptor string) {
...
// The merchant identifier (commonly abbreviated as MID) of the merchant the card
// is transacting with.
func (r *RealTimeDecisionsCardAuthorizationActionResponse) GetMerchantAcceptorId() (MerchantAcceptorId string) {
...
// The city the merchant resides in.
func (r *RealTimeDecisionsCardAuthorizationActionResponse) GetMerchantCity() (MerchantCity string) {
...
// The country the merchant resides in.
func (r *RealTimeDecisionsCardAuthorizationActionResponse) GetMerchantCountry() (MerchantCountry string) {
