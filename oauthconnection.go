...
func (r *OAuthConnectionService) List(ctx context.Context, query OAuthConnectionListParams, opts ...option.RequestOption) (res *OAuthConnectionListResponse, err error) {
	opts = slices.Concat(r.Options, opts)
...
type OAuthConnectionListResponse struct {
	...
	JSON        oauthConnectionListResponseJSON `json:"-"`
}
...
func (r oauthConnectionListResponseJSON) RawJSON() string {
	return r.raw
}
