...
const (
	...
	SimulationEntityUpdateValidationParamsIssuesCategoryEntityIdentity               SimulationEntityUpdateValidationParamsIssuesCategory = "entity_identity"
	...
	SimulationEntityUpdateValidationParamsIssuesCategoryBeneficialOwnerTaxIdentifier SimulationEntityUpdateValidationParamsIssuesCategory = "beneficial_owner_tax_identifier"
)

func (r SimulationEntityUpdateValidationParamsIssuesCategory) IsKnown() bool {
	switch r {
	case SimulationEntityUpdateValidationParamsIssuesCategoryEntityTaxIdentifier, SimulationEntityUpdateValidationParamsIssuesCategoryEntityAddress, SimulationEntityUpdateValidationParamsIssuesCategoryEntityIdentity, SimulationEntityUpdateValidationParamsIssuesCategoryBeneficialOwnerIdentity, SimulationEntityUpdateValidationParamsIssuesCategoryBeneficialOwnerAddress, SimulationEntityUpdateValidationParamsIssuesCategoryBeneficialOwnerTaxIdentifier:
		return true
	}
	return false
}
