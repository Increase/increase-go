...
const (
	...
	CheckTransferPhysicalCheckTrackingUpdatesCategoryReturningToSender    CheckTransferPhysicalCheckTrackingUpdatesCategory = "returning_to_sender"
...
func (r CheckTransferPhysicalCheckTrackingUpdatesCategory) IsKnown() bool {
	switch r {
	case CheckTransferPhysicalCheckTrackingUpdatesCategoryInTransit, CheckTransferPhysicalCheckTrackingUpdatesCategoryProcessedForDelivery, CheckTransferPhysicalCheckTrackingUpdatesCategoryDelivered, CheckTransferPhysicalCheckTrackingUpdatesCategoryDeliveryIssue, CheckTransferPhysicalCheckTrackingUpdatesCategoryReturningToSender, CheckTransferPhysicalCheckTrackingUpdatesCategoryReturnedToSender:
		return true
	}
	return false
}
