...
const (
	...
	CardValidationDeclineReasonBlockedByCardholder                                     CardValidationDeclineReason = "blocked_by_cardholder"
	...
	CardValidationDeclineReasonUnableToLocateRecord                                    CardValidationDeclineReason = "unable_to_locate_record"
	CardValidationDeclineReasonFileIsTemporarilyUnavailable                            CardValidationDeclineReason = "file_is_temporarily_unavailable"
	CardValidationDeclineReasonIncorrectPin                                            CardValidationDeclineReason = "incorrect_pin"
	CardValidationDeclineReasonAllowableNumberOfPinEntryTriesExceeded                  CardValidationDeclineReason = "allowable_number_of_pin_entry_tries_exceeded"
	CardValidationDeclineReasonUnableToLocatePreviousMessage                           CardValidationDeclineReason = "unable_to_locate_previous_message"
	CardValidationDeclineReasonDataInconsistentWithOriginalMessage                     CardValidationDeclineReason = "data_inconsistent_with_original_message"
	CardValidationDeclineReasonPinErrorFound                                           CardValidationDeclineReason = "pin_error_found"
	CardValidationDeclineReasonCannotVerifyPin                                         CardValidationDeclineReason = "cannot_verify_pin"
	CardValidationDeclineReasonVerificationDataFailed                                  CardValidationDeclineReason = "verification_data_failed"
	CardValidationDeclineReasonSurchargeAmountNotSupportedByDebitNetworkIssuer         CardValidationDeclineReason = "surcharge_amount_not_supported_by_debit_network_issuer"
	CardValidationDeclineReasonCashServiceNotAvailable                                 CardValidationDeclineReason = "cash_service_not_available"
	CardValidationDeclineReasonCashbackRequestExceedsIssuerLimit                       CardValidationDeclineReason = "cashback_request_exceeds_issuer_limit"
	CardValidationDeclineReasonTransactionAmountExceedsPreAuthorizedApprovalAmount     CardValidationDeclineReason = "transaction_amount_exceeds_pre_authorized_approval_amount"
	CardValidationDeclineReasonInvalidBillerInformation                                CardValidationDeclineReason = "invalid_biller_information"
	CardValidationDeclineReasonPinChangeRequestDeclined                                CardValidationDeclineReason = "pin_change_request_declined"
	CardValidationDeclineReasonUnsafePin                                               CardValidationDeclineReason = "unsafe_pin"
	CardValidationDeclineReasonTransactionDoesNotQualifyForVisaPin                     CardValidationDeclineReason = "transaction_does_not_qualify_for_visa_pin"
	CardValidationDeclineReasonOfflineDeclined                                         CardValidationDeclineReason = "offline_declined"
	CardValidationDeclineReasonUnableToGoOnline                                        CardValidationDeclineReason = "unable_to_go_online"
	CardValidationDeclineReasonValidAccountButAmountNotSupported                       CardValidationDeclineReason = "valid_account_but_amount_not_supported"
	CardValidationDeclineReasonInvalidUseOfMerchantCategoryCodeCorrectAndReattempt     CardValidationDeclineReason = "invalid_use_of_merchant_category_code_correct_and_reattempt"
	CardValidationDeclineReasonForwardToIssuer                                         CardValidationDeclineReason = "forward_to_issuer"
	CardValidationDeclineReasonCardAuthenticationFailed                                CardValidationDeclineReason = "card_authentication_failed"
)

func (r CardValidationDeclineReason) IsKnown() bool {
	switch r {
	case CardValidationDeclineReasonDoNotHonor, CardValidationDeclineReasonActivityCountLimitExceeded, CardValidationDeclineReasonReferToCardIssuer, CardValidationDeclineReasonReferToCardIssuerSpecialCondition, CardValidationDeclineReasonInvalidMerchant, CardValidationDeclineReasonPickUpCard, CardValidationDeclineReasonError, CardValidationDeclineReasonPickUpCardSpecial, CardValidationDeclineReasonInvalidTransaction, CardValidationDeclineReasonInvalidAmount, CardValidationDeclineReasonInvalidAccountNumber, CardValidationDeclineReasonNoSuchIssuer, CardValidationDeclineReasonReEnterTransaction, CardValidationDeclineReasonNoCreditAccount, CardValidationDeclineReasonPickUpCardLost, CardValidationDeclineReasonPickUpCardStolen, CardValidationDeclineReasonClosedAccount, CardValidationDeclineReasonInsufficientFunds, CardValidationDeclineReasonNoCheckingAccount, CardValidationDeclineReasonNoSavingsAccount, CardValidationDeclineReasonExpiredCard, CardValidationDeclineReasonTransactionNotPermittedToCardholder, CardValidationDeclineReasonTransactionNotAllowedAtTerminal, CardValidationDeclineReasonTransactionNotSupportedOrBlockedByIssuer, CardValidationDeclineReasonSuspectedFraud, CardValidationDeclineReasonActivityAmountLimitExceeded, CardValidationDeclineReasonRestrictedCard, CardValidationDeclineReasonSecurityViolation, CardValidationDeclineReasonTransactionDoesNotFulfillAntiMoneyLaunderingRequirement, CardValidationDeclineReasonBlockedByCardholder, CardValidationDeclineReasonBlockedFirstUse, CardValidationDeclineReasonCreditIssuerUnavailable, CardValidationDeclineReasonNegativeCardVerificationValueResults, CardValidationDeclineReasonIssuerUnavailable, CardValidationDeclineReasonFinancialInstitutionCannotBeFound, CardValidationDeclineReasonTransactionCannotBeCompleted, CardValidationDeclineReasonDuplicateTransaction, CardValidationDeclineReasonSystemMalfunction, CardValidationDeclineReasonAdditionalCustomerAuthenticationRequired, CardValidationDeclineReasonSurchargeAmountNotPermitted, CardValidationDeclineReasonDeclineForCvv2Failure, CardValidationDeclineReasonStopPaymentOrder, CardValidationDeclineReasonRevocationOfAuthorizationOrder, CardValidationDeclineReasonRevocationOfAllAuthorizationsOrder, CardValidationDeclineReasonUnableToLocateRecord, CardValidationDeclineReasonFileIsTemporarilyUnavailable, CardValidationDeclineReasonIncorrectPin, CardValidationDeclineReasonAllowableNumberOfPinEntryTriesExceeded, CardValidationDeclineReasonUnableToLocatePreviousMessage, CardValidationDeclineReasonDataInconsistentWithOriginalMessage, CardValidationDeclineReasonPinErrorFound, CardValidationDeclineReasonCannotVerifyPin, CardValidationDeclineReasonVerificationDataFailed, CardValidationDeclineReasonSurchargeAmountNotSupportedByDebitNetworkIssuer, CardValidationDeclineReasonCashServiceNotAvailable, CardValidationDeclineReasonCashbackRequestExceedsIssuerLimit, CardValidationDeclineReasonTransactionAmountExceedsPreAuthorizedApprovalAmount, CardValidationDeclineReasonInvalidBillerInformation, CardValidationDeclineReasonPinChangeRequestDeclined, CardValidationDeclineReasonUnsafePin, CardValidationDeclineReasonTransactionDoesNotQualifyForVisaPin, CardValidationDeclineReasonOfflineDeclined, CardValidationDeclineReasonUnableToGoOnline, CardValidationDeclineReasonValidAccountButAmountNotSupported, CardValidationDeclineReasonInvalidUseOfMerchantCategoryCodeCorrectAndReattempt, CardValidationDeclineReasonForwardToIssuer, CardValidationDeclineReasonCardAuthenticationFailed:
		return true
	}
	return false
}
