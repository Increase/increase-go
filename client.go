...
// INCREASE_WEBHOOK_SECRET, INCREASE_BASE_URL). This should be used to initialize
// new clients.
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("INCREASE_CUSTOM_HEADERS"); ok {
...
// environment (INCREASE_API_KEY, INCREASE_WEBHOOK_SECRET, INCREASE_BASE_URL). The
...
func NewClient(opts ...option.RequestOption) (r *Client) {
	...
	r.LockboxAddresses = NewLockboxAddressService(opts...)
	r.LockboxRecipients = NewLockboxRecipientService(opts...)
