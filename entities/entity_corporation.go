...
type EntityCorporation struct {
	...
	Address *EntityCorporationAddress `json:"address,omitempty"`

	// The identifying details of anyone controlling or owning 25% or more of the
	// corporation.
	BeneficialOwners *[]EntityCorporationBeneficialOwner `json:"beneficial_owners,omitempty"`
}
...
// The identifying details of anyone controlling or owning 25% or more of the
// corporation.
func (r *EntityCorporation) GetBeneficialOwners() (BeneficialOwners []EntityCorporationBeneficialOwner) {
