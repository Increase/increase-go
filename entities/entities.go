...
type EntityList struct {
	...
	Data *[]shared.Entity `json:"data"`
	// A pointer to a place in the list.
	NextCursor *string `json:"next_cursor"`
}

// The contents of the list.
func (r *EntityList) GetData() (Data []shared.Entity) {
	if r != nil && r.Data != nil {
		Data = *r.Data
	}
	return
...
func (r *EntityService) Create(ctx context.Context, body *CreateAnEntityParameters, opts ...*core.RequestOpts) (res *shared.Entity, err error) {
	err = r.post(
		ctx,
		"/entities",
		&core.CoreRequest{
...
func (r *PreloadedEntityService) Create(ctx context.Context, body *CreateAnEntityParameters, opts ...*core.RequestOpts) (res *shared.Entity, err error) {
	err = r.Entities.post(
		ctx,
		"/entities",
		&core.CoreRequest{
...
func (r *EntityService) Retrieve(ctx context.Context, entity_id string, opts ...*core.RequestOpts) (res *shared.Entity, err error) {
	err = r.get(
		ctx,
...
func (r *PreloadedEntityService) Retrieve(ctx context.Context, entity_id string, opts ...*core.RequestOpts) (res *shared.Entity, err error) {
	err = r.Entities.get(
		ctx,
		fmt.Sprintf("/entities/%s", entity_id),
		&core.CoreRequest{
...
type EntitiesPage struct {
	*pagination.Page[shared.Entity]
}

func (r *EntitiesPage) Entity() *shared.Entity {
	return r.Current()
}
...
func (r *EntityService) List(ctx context.Context, query *ListEntitiesQuery, opts ...*core.RequestOpts) (res *EntitiesPage, err error) {
	page := &EntitiesPage{
		Page: &pagination.Page[shared.Entity]{
