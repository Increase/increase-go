...
func TestSimulationRealTimePaymentsTransferCompleteWithOptionalParams(t *testing.T) {
	...
	_, err := c.Simulations.RealTimePaymentsTransfers.Complete(
		...
		&requests.SimulationRealTimePaymentsTransferCompleteParams{Rejection: increase.F(requests.SimulationRealTimePaymentsTransferCompleteParamsRejection{RejectReasonCode: increase.F(requests.SimulationRealTimePaymentsTransferCompleteParamsRejectionRejectReasonCodeAccountClosed)})},
	)
	if err != nil {
